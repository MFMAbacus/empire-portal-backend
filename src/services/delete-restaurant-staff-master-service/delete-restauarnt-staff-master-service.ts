...
export class DeleteRestaurantStaffMasterService {
  ...
  public async execute(input: Input): Promise<Result<string, Failure>> {
    ...
    const record = await this._restaurantStaffMasterRepository.get(id.get());
    ...
    await this._restaurantStaffMasterRepository.Update(record);
