...
import { courtTimeMasterRouter } from "./routers/court-time-master-router";
import { facilityApprovalMasterRouter } from "./routers/facility-approval-master-router";
...
app.use("/court-operating-master", courtOperatingMasterRouter);
app.use("/court-time-master", courtTimeMasterRouter);
app.use("/facility-approval-master", facilityApprovalMasterRouter);
app.use("/court-blocking-master", courtBlockingMasterRouter);
