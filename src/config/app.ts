...
export const fibInvoiceStatusCallbackUrl =
  "http:/c21531-empirebackendtest.cloudiax.com/invoices-payments";
export const cronTimeConfig = "*/5 * * * * *";
...
export const hyperPayEnvironment = env("HYPERPAY_ENVIRONMENT", "test");
