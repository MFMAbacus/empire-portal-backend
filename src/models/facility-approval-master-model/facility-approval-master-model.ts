...
export class FacilityApprovalMasterModel extends Model {
  public static make(record: Partial<IFacilityApprovalMaster>): FacilityApprovalMasterModel {
    const filteredRecord: Partial<IFacilityApprovalMaster> = {
      _id: record._id,
      id: record.id,
    ...
    const model = new FacilityApprovalMasterModel(Model._makeAttributes(filteredRecord));
    return model;
  }
